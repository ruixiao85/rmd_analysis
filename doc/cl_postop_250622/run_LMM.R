# --- 1. SETUP & LIBRARIES ---
required_packages <- c("tidyverse", "lme4", "lmerTest", "ggpubr", "readxl", "extrafont", "emmeans", "sjPlot", "pROC")
...
dt <- readxl::read_excel("postop_260504_CL.xlsx")
...
vars=c(
  ...
  # "E/A", "DT", "e", "E/e",
  # "LVEDV", "LVESV", "LVSimpston", "A4C", "A2C", "APLAX", "GloblStrainAV", "PSD", "GWI", "GCW", "GWW", "GWE", "LA1", "LA2", "LA3", "LAVmin", "LAVmax", "LAVpreA", "LAVImax", "LAEV", "LAEF", "LASr", "LAScd", "LASct", "LASrc", "LAScdc", "LASctc"
...
# --- 5. EXPORT ---
system("pandoc run_log.md -o run_log.docx --standalone")
cat("Analysis complete. Check 'out' folder and run_log.docx\n")
